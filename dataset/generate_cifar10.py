...
local_size = 600
noniid_s = 80
dir_path = "cifar10_"+str(num_clients)+"_"+str(noniid_s)+'_'+str(local_size)+"/"


# Allocate data to users
def generate_cifar10(niid, balance, partition):
    ...
    train_data = cifar_noniid_s(trainset, num_clients, noniid_s, local_size, train=True)
    test_data = cifar_noniid_s (testset, num_clients,noniid_s, local_size, train=False)
...
if __name__ == "__main__":
    ...
    generate_cifar10(niid, balance, partition)